...
if __name__=="__main__":
    for v in versions:
        ...
        with open("Train_Log.txt", mode, encoding="utf-8") as f:
            f.write(f"Model : {v}\n")
            f.write(f"Total training taked : {training_time//60} : {training_time%60}\n")
            f.write(f"Feature extracting taked : {feature_time//60} : {feature_time%60}\n")
